...
namespace Broccoli.BroccoEditor
{
    public class PreviewRenderUtility : UnityEditor.PreviewRenderUtility {
        ...
        public void DrawMeshB(Mesh mesh, Vector3 pos, Vector3 scale, Quaternion rot, Material mat, int subMeshIndex)
        {
            DrawMeshB(mesh, pos, scale, rot, mat, subMeshIndex, null, null, false);
        }
