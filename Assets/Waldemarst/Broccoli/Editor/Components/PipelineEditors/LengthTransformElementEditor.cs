...
{
	/// <summary>
	/// Length transform element editor.
	/// </summary>
	[CustomEditor(typeof(LengthTransformElement))]
	public class LengthTransformElementEditor : PipelineElementEditor {
		#region Vars
		/// <summary>
		...
		protected override void OnEnableSpecific () {
			lengthTransformElement = target as LengthTransformElement;
		...
		protected override void OnInspectorGUISpecific () {
			...
			if (EditorGUI.EndChangeCheck () &&
				...
				lengthTransformElement.Validate ();
