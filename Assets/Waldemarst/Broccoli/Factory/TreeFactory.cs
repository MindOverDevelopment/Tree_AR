...
namespace Broccoli.Factory
{
	...
	public class TreeFactory : MonoBehaviour {
		...
		/// <param name="tree">BroccoTree instance.</param>
		/// <param name="path">Name for the prefab.</param>
		...
		public bool CreatePrefab () {
			...
			if (localPipeline != null && ValidatePipeline (localPipeline)) {
				...
				_assetManager.BeginWithCreatePrefab (previewTree.obj,
					prefabSavePath, treeFactoryPreferences.prefabSavePrefix + prefabSuffix);
				...
				*/
				...
				if (onBeforeEndPrefabCommit != null) {
					onBeforeEndPrefabCommit (_localPipeline, _previewTree, _assetManager.prefabName,
				...
				if (result) {
					...
					if (onEndPrefabCommit != null) {
						onEndPrefabCommit (_localPipeline, _previewTree, _assetManager.prefabName,
							_assetManager.prefabFullPath, _assetManager.prefabResourcesPath, _assetManager.assetInfos);
					}
				}
				EndPrefabProgress ();
