...
namespace Broccoli.Pipe {
	...
	public class LengthTransformElement : PipelineElement {
		...
		public LengthTransformElement () {
			this.elementName = "Length Transform";
			this.elementHelpURL = "https://docs.google.com/document/d/1Nr6Z808i7X2zMFq8PELezPuSJNP5IvRx9C5lJxZ_Z-A/edit#heading=h.wpq06kezyqw";
			this.elementDescription = "This node display option to modify the length of branches present on the tree structure.";
		}
		#endregion
