...
namespace Broccoli.Pipe {
	...
	public class SparsingTransformElement : PipelineElement {
		...
		public SparsingTransformElement () {
			this.elementName = "Sparse Transform";
			this.elementHelpURL = "https://docs.google.com/document/d/1Nr6Z808i7X2zMFq8PELezPuSJNP5IvRx9C5lJxZ_Z-A/edit#heading=h.qhtlgz8vf6cy";
			this.elementDescription = "This node display options to modifiy the spacing and distribution of branches on the levels of the tree structure.";
		}
		#endregion
